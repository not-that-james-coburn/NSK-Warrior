...
const APP_CONFIG = {
  ...
  versions: {
    ...
    'tp': {
      ...
      versionAlert: false,
      alertMessage: "Please wait for next update.\nComing soon!",
      update: "2.2", // Cart, Cramalot, Assembly Cart cinematic, Filter rooms, Assembly quests, Assembly door fix, bosses difficulty tweeked up
      versionInfo: true,
      get infoMessage() {
